...
export default function WelcomeBanner({ imageOne, imageTwo, hintClass, bannerOne, bannerTwo }) {
    return (
        <section aria-label='home-banner' className="relative portrait:sm:w-[95%] portrait:w-full landscape:w-full landscape:pl-4 landscape:pr-4 mx-auto lg:mx-0 lg:w-full portrait:h-[24em] landscape:lg:h-[40em] landscape:h-[100vh] landscape:md:h-[100vh]">
