...
export default function SimpleCard ({title, text, image, className}) {
    return (
        <section className={`${className} relative landscape:w-[9.5em] landscape:lg:w-[15.5em] landscape:min-h-full landscape:lg:h-full landscape:sm:h-full landscape:md:h-full landscape:md:w-[11em] mx-auto lg:mx-0 lg:h-[90%] portrait:h-[35em] portrait:w-[80%] portrait:sm:w-[10em] portrait:sm:h-[20em]`}>
