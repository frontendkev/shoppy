...
const AddToCartTab = ({ product, saveLastViewed, url, className }) => {
    ...
    function sendLastSeen() {
        return saveLastViewed(product.id, product.title, product.type, product.image.file)
    }
    return (
        

        <section className={`${className} relative landscape:md:w-[10em] landscape:lg:w-[15em] landscape:lg:h-[400px] landscape:xl:h-[450px] flex flex-col landscape:w-[11em] landscape:h-[20em] portrait:w-full portrait:h-[520px] portrait:sm:w-[12em] portrait:md:w-[15em] portrait:lg:w-[15em] portrait:lg:h-[25em] landscape:xl:pl-0 portrait:sm:h-[450px]`}>
