...
const AddToCartTab = ({ product, saveLastViewed, url, className }) => {
    ...
    return (
        ...
        <section className={`${className} relative  landscape:md:w-[10em] landscape:lg:w-[15em] landscape:lg:h-[24em] landscape:xl:h-[30em] flex flex-col landscape:w-[11em] landscape:h-[20em] portrait:w-full portrait:h-[520px] portrait:md:w-[11.55em] portrait:lg:w-[15em] portrait:lg:h-[25em] landscape:xl:pl-0`}>
