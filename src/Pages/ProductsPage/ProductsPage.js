...
export default function ProductsPage () {
    ...
    return (
        <section className={`w-full h-full relative`}>
            <BreadCrumbs />
            <section className=" relative w-full h-[2em] flex justify-center items-center bg-gray-100 landscape:md:h-[2.8em]">
            ...
            {loaderData.length === 0 &&
                <section className={'w-full h-[20em] relative flex flex-col justify-center items-center gap-y-2'}>
                    <div className="relative w-[6em] h-[6em] rounded-full bg-gray-300 opacity-70 mx-auto mb-2 before:absolute before:bg-rose-300 before:opacity-70 before:w-[6em] before:h-[6em] before:rounded-full before:left-[-1.5em] before:z-[5] z-[10] shadow-light before:shadow-light">
